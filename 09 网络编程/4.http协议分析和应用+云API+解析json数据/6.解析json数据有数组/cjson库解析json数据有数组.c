...
int main()
{
	...
	//原始的json数据
	char *jsondata="{\"姓名\":\"张三\",\"成绩\":{\"语文\":125,\"数学\":115,\"英语\":135,\"物理\":73,\"化学\":68},\"爱好\":[\"打篮球\",\"健身\",\"看书\"]}";
	...
	*/
	...
	//解析"爱好"这个键对应的值
	cJSON *val5=cJSON_GetObjectItem(myjson,"爱好"); 
	//观察发现val5是个数组，继续解析数组里面的内容
	for(int i=0; i<cJSON_GetArraySize(val5); i++)
	{
		cJSON *val6=cJSON_GetArrayItem(val5,i);
		printf("这个同学的爱好: %s\n",val6->valuestring);
	}
